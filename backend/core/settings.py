...
CSRF_COOKIE_SECURE = not DEBUG  # Only over HTTPS in production
...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get('DB_NAME', 'social_automation_hub'),
...
RATELIMIT_VIEW_RATES = {
    'oauth:start': '5/m',
    'oauth:callback': '10/m',
    'analytics:dashboard': '30/m',
    'analytics:followers': '20/m',
    'content:generate_ai': '10/h',
    'posts:create': '50/h',
    'posts:publish': '20/h',
    'automations:execute': '100/h',
}
